...
```groovy
dependencies {
  modImplementation "com.teamresourceful.resourcefulconfig:resourcefulconfig-common-1.21.9:3.9.2"
}
```
...
```groovy
dependencies {
  modImplementation "com.teamresourceful.resourcefulconfig:resourcefulconfig-fabric-1.21.9:3.9.2"
}
```
...
```groovy
dependencies {
  modImplementation "com.teamresourceful.resourcefulconfig:resourcefulconfig-neoforge-1.21.9:3.9.2"
}
```
