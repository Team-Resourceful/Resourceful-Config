...
```groovy
dependencies {
  modImplementation "com.teamresourceful.resourcefulconfig:resourcefulconfig-common-1.21.11:3.11.1"
}
```
...
```groovy
dependencies {
  modImplementation "com.teamresourceful.resourcefulconfig:resourcefulconfig-fabric-1.21.11:3.11.1"
}
```
...
```groovy
dependencies {
  modImplementation "com.teamresourceful.resourcefulconfig:resourcefulconfig-neoforge-1.21.11:3.11.1"
}
```
